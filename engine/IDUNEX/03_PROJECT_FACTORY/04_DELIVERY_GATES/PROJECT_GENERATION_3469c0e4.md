# PROJECT_GENERATION_RETRY_LOOP_UNTIL_PASS
...
## actual_value
artifact=PROJECT_GENERATION_RETRY_LOOP_UNTIL_PASS; status=RESTORED; blocking=true; audit_scope=engine_and_project_factory
