# SKETCH_TO_REAL_ADAPTER

## propósito
Formaliza sketch, wireframe or storyboard conversion into realistic IDUNEX output como regla productiva base de IDUNEX v1.0.0. Autoridad activa: PRODUCTIVE_BASE_ENGINE. Cada salida real queda bloqueada hasta QA, sidecar, hash y lineage por output.
