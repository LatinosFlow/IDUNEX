# REFERENCE_IMAGE_TRANSFER_CONTRACT

## propósito
Formaliza reference image transfer for pose, wardrobe, framing, light and environment como regla productiva base de IDUNEX v1.0.0. Autoridad activa: PRODUCTIVE_BASE_ENGINE. Cada salida real queda bloqueada hasta QA, sidecar, hash y lineage por output.
...
## Reference image transfer 4f405
Use reference image only for pose, encuadre, wardrobe, style, iluminación and ambiente. No copiar identidad facial real ajena. The final identity remains the IDUNEX Profile360 model.
