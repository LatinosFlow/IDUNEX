# SKETCH_TO_REAL_CONTRACT

## propósito
Formaliza sketch to real image contract with model, scene, camera, light, clothing and props como regla productiva base de IDUNEX v1.0.0. Autoridad activa: PRODUCTIVE_BASE_ENGINE. Cada salida real queda bloqueada hasta QA, sidecar, hash y lineage por output.
...
## Sketch-to-real 4f405
Convertir boceto, dibujo, esquema, wireframe, storyboard o composición manual en imagen realista siguiendo modelo, Profile360, escena, cámara, luz, ropa, props, física espacial y QA.
