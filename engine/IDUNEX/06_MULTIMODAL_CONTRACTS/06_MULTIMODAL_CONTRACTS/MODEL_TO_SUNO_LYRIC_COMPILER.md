# MODEL_TO_SUNO_LYRIC_COMPILER

## propósito
Formaliza Suno lyrics from model POV with structure, emotion, hook and production notes como regla productiva base de IDUNEX v1.0.0. Autoridad activa: PRODUCTIVE_BASE_ENGINE. Cada salida real queda bloqueada hasta QA, sidecar, hash y lineage por output.
...
## Required output skeleton 4f405
- TITLE
- STYLE TAGS
- GENRE / SUBGENRE
- BPM
...
## Fallback fixes 4f405
- If lyric is generic, reload Profile360 27-34 and rewrite hook from model memory, conflict, speech rhythm and voice direction.
