# WARDROBE_BODY_SCENE_PHYSICS_CONTRACT

## propósito
Formaliza wardrobe fit, body contact, scene props and physical collisions como regla productiva base de IDUNEX v1.0.0. Autoridad activa: PRODUCTIVE_BASE_ENGINE. Cada salida real queda bloqueada hasta QA, sidecar, hash y lineage por output.
...
## Wardrobe/body/scene physics 4f405
Validar fit corporal, costuras, tensión textil, caída por gravedad, capas de ropa, tirantes, cinturones, correas, joyería, lentes, accesorios, contact, clipping, props, body intersection, no ropa atravesando piel, no props atravesando cuerpo, no objetos flotando, escala humana correcta, sombras y reflejos correctos.
