...
# AGENT_FACTORY_CHATGPT_COPILOT_CONTRACT
...
## Propósito
Garantiza paridad operacional entre agentes ChatGPT y Copilot: ambos ejecutan la misma capacidad runtime con formatos adecuados.
...
## Alcance
CHATGPT core MD/TXT, COPILOT core DOCX/TXT, CONFIG 8000, modelos, source trace, QA, sidecars y vendor handoff.. Aplica a motor base `IDUNEX_MOTOR_VERSION = v1.0.0`, Project Factory, Agent Factory, CHATGPT, COPILOT, Profile360, manifests, sidecars, validators, hash lineage y exportación productiva controlada. No autoriza PROJECT_INSTANCE_GO ni OUTPUT_GO sin QA propio.
...
## Load order
1) PROJECT_CORE. 2) 10 archivos ChatGPT. 3) 10 archivos Copilot. 4) CONFIG 8000. 5) MODELS/Profile360. 6) MANIFESTS.
...
- `IDUNEX/03_PROJECT_FACTORY/01_TEMPLATES/IDUNEX_PROJECT_TEMPLATE_v1.0.0/CHATGPT/`
- `IDUNEX/03_PROJECT_FACTORY/01_TEMPLATES/IDUNEX_PROJECT_TEMPLATE_v1.0.0/COPILOT/`
...
## Fail codes
- `FAIL_CHATGPT_CORE_COUNT`: bloquea entrega hasta fix, evidencia y re-test.
- `FAIL_COPILOT_CORE_COUNT`: bloquea entrega hasta fix, evidencia y re-test.
- `FAIL_COPILOT_DOWNGRADED`: bloquea entrega hasta fix, evidencia y re-test.
- `FAIL_CONFIG_8000`: bloquea entrega hasta fix, evidencia y re-test.
...
## Ejemplos PASS/FAIL
- PASS: DOCX Copilot contiene H1/H2/H3, tablas, QA, fallbacks y source trace equivalente al MD ChatGPT.
- FAIL: Copilot recibe solo resumen o instrucciones inferiores a ChatGPT.
...
## Relación operativa
CHATGPT puede operar con markdown; COPILOT opera con DOCX estructurado. Ambos deben obedecer PROJECT_CORE y Profile360, no memoria libre.
