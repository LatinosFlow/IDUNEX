# Idunex Normativa Motor Generacion Actualizacion
...
**Mandato:** generar o actualizar motor desde cero con no-loss, source-to-runtime, auditoría N ciclos y naming limpio.
## Política aplicada a Identidad, memoria, biografía, cultura segura y persona digital adulta
...
**Regla 01 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 02 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 03 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 04 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 05 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 06 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 07 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 08 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 09 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 10 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 11 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 12 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 13 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 14 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.

**Regla 15 — Identidad, memoria, biografía, cultura segura y persona digital adulta**: todo agente debe transformar este dominio en campo verificable. No basta declarar intención; debe existir impacto en prompt, sidecar, QA y fallback. Si una salida falla, se registra fail code, se aplica reparación y se ejecuta re-test. Ejemplo de control: no aceptar descripciones genéricas, no usar datos ausentes, no migrar evidencia no canon a identidad, no omitir relación con cámara/luz/movimiento/voz/wardrobe/escena.
...
## Política aplicada a Rostro forense, landmarks, edad visual y autenticación de identidad
...
## Política aplicada a Cuerpo, antropometría, edad adulta, fitness editorial y uniqueness corporal
...
## Política aplicada a Piel, dermatología visual, cabello y materialidad humana
...
## Política aplicada a Voz hablada, lenguaje, acento, escritura, canto y música
...
## Política aplicada a Acting, FACS, microgestos, pose, caminada y continuidad de video
...
## Política aplicada a Wardrobe, bodywear editorial adulto, props, materiales y física textil
...
## Política aplicada a Cámara, lente, iluminación, color, escena y física espacial
...
## Política aplicada a Gobernanza, sidecar, watermark, legal, QA, no-loss y lineage
...
|---|---|---|
| FAIL_CANONICAL_NAME_DRIFT_OR_GAP | BLOCKED | Reforzar canonical name con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_MODEL_CODE_DRIFT_OR_GAP | BLOCKED | Reforzar model code con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_ALIASES_DRIFT_OR_GAP | BLOCKED | Reforzar aliases con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_ADULT_AGE_DRIFT_OR_GAP | BLOCKED | Reforzar adult age con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_VISUAL_AGE_DRIFT_OR_GAP | BLOCKED | Reforzar visual age con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_BODY_AGE_DRIFT_OR_GAP | BLOCKED | Reforzar body age con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_VOCAL_AGE_DRIFT_OR_GAP | BLOCKED | Reforzar vocal age con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_PROJECT_ROLE_DRIFT_OR_GAP | BLOCKED | Reforzar project role con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CANON_SCOPE_DRIFT_OR_GAP | BLOCKED | Reforzar canon scope con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_MUTABLE_SCOPE_DRIFT_OR_GAP | BLOCKED | Reforzar mutable scope con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_IMMUTABLE_SCOPE_DRIFT_OR_GAP | BLOCKED | Reforzar immutable scope con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_IDENTITY_STATUS_DRIFT_OR_GAP | BLOCKED | Reforzar identity status con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_RELATIONSHIP_TO_PROJECT_DRIFT_OR_GAP | BLOCKED | Reforzar relationship to project con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_PERSONA_BOUNDARY_DRIFT_OR_GAP | BLOCKED | Reforzar persona boundary con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_PRIVATE_PUBLIC_BOUNDARY_DRIFT_OR_GAP | BLOCKED | Reforzar private public boundary con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_BIRTH_CONTEXT_DRIFT_OR_GAP | BLOCKED | Reforzar birth context con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FAMILY_STRUCTURE_DRIFT_OR_GAP | BLOCKED | Reforzar family structure con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_MIGRATION_TRACE_DRIFT_OR_GAP | BLOCKED | Reforzar migration trace con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_EDUCATION_TRACE_DRIFT_OR_GAP | BLOCKED | Reforzar education trace con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_WORK_TRACE_DRIFT_OR_GAP | BLOCKED | Reforzar work trace con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SOCIAL_ENVIRONMENT_DRIFT_OR_GAP | BLOCKED | Reforzar social environment con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FORMATIVE_EVENTS_DRIFT_OR_GAP | BLOCKED | Reforzar formative events con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_LIFE_TURNING_POINTS_DRIFT_OR_GAP | BLOCKED | Reforzar life turning points con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HABIT_MAP_DRIFT_OR_GAP | BLOCKED | Reforzar habit map con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_DAILY_ROUTINES_DRIFT_OR_GAP | BLOCKED | Reforzar daily routines con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_MEMORY_TRIGGERS_DRIFT_OR_GAP | BLOCKED | Reforzar memory triggers con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_EMOTIONAL_ANCHORS_DRIFT_OR_GAP | BLOCKED | Reforzar emotional anchors con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_PERSONAL_LIMITS_DRIFT_OR_GAP | BLOCKED | Reforzar personal limits con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CONFLICT_HISTORY_DRIFT_OR_GAP | BLOCKED | Reforzar conflict history con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_GROWTH_ARC_DRIFT_OR_GAP | BLOCKED | Reforzar growth arc con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_TEMPERAMENT_DRIFT_OR_GAP | BLOCKED | Reforzar temperament con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_MOTIVATION_STACK_DRIFT_OR_GAP | BLOCKED | Reforzar motivation stack con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FEAR_STACK_DRIFT_OR_GAP | BLOCKED | Reforzar fear stack con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_DESIRE_STACK_DRIFT_OR_GAP | BLOCKED | Reforzar desire stack con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_VALUES_MAP_DRIFT_OR_GAP | BLOCKED | Reforzar values map con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_MORAL_BOUNDARIES_DRIFT_OR_GAP | BLOCKED | Reforzar moral boundaries con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_WORLDVIEW_DRIFT_OR_GAP | BLOCKED | Reforzar worldview con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CONTRADICTIONS_DRIFT_OR_GAP | BLOCKED | Reforzar contradictions con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HUMOR_STYLE_DRIFT_OR_GAP | BLOCKED | Reforzar humor style con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_DECISION_STYLE_DRIFT_OR_GAP | BLOCKED | Reforzar decision style con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SOCIAL_REACTION_DRIFT_OR_GAP | BLOCKED | Reforzar social reaction con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CONFLICT_RESPONSE_DRIFT_OR_GAP | BLOCKED | Reforzar conflict response con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CONFIDENCE_PATTERN_DRIFT_OR_GAP | BLOCKED | Reforzar confidence pattern con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_ATTENTION_STYLE_DRIFT_OR_GAP | BLOCKED | Reforzar attention style con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_EMPATHY_PATTERN_DRIFT_OR_GAP | BLOCKED | Reforzar empathy pattern con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_INNER_VOICE_DRIFT_OR_GAP | BLOCKED | Reforzar inner voice con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_WRITTEN_VOICE_DRIFT_OR_GAP | BLOCKED | Reforzar written voice con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SPEECH_REGISTER_DRIFT_OR_GAP | BLOCKED | Reforzar speech register con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SILENCE_STYLE_DRIFT_OR_GAP | BLOCKED | Reforzar silence style con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_VOCABULARY_RANGE_DRIFT_OR_GAP | BLOCKED | Reforzar vocabulary range con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_PERUVIAN_LATAM_USAGE_DRIFT_OR_GAP | BLOCKED | Reforzar peruvian latam usage con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SOCIOLECT_LIMIT_DRIFT_OR_GAP | BLOCKED | Reforzar sociolect limit con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_INTERVIEW_VOICE_DRIFT_OR_GAP | BLOCKED | Reforzar interview voice con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CAPTION_VOICE_DRIFT_OR_GAP | BLOCKED | Reforzar caption voice con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SCRIPT_VOICE_DRIFT_OR_GAP | BLOCKED | Reforzar script voice con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_NO_GENERIC_TEXT_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar no generic text rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_NON_IMITATION_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar non imitation rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FACE_SHAPE_DRIFT_OR_GAP | BLOCKED | Reforzar face shape con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CRANIAL_VISUAL_VOLUME_DRIFT_OR_GAP | BLOCKED | Reforzar cranial visual volume con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_VERTICAL_THIRDS_DRIFT_OR_GAP | BLOCKED | Reforzar vertical thirds con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HORIZONTAL_FIFTHS_DRIFT_OR_GAP | BLOCKED | Reforzar horizontal fifths con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FOREHEAD_HEIGHT_DRIFT_OR_GAP | BLOCKED | Reforzar forehead height con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HAIRLINE_RELATION_DRIFT_OR_GAP | BLOCKED | Reforzar hairline relation con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_TEMPLE_WIDTH_DRIFT_OR_GAP | BLOCKED | Reforzar temple width con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CHEEKBONE_POSITION_DRIFT_OR_GAP | BLOCKED | Reforzar cheekbone position con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_MIDFACE_LENGTH_DRIFT_OR_GAP | BLOCKED | Reforzar midface length con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_LOWER_FACE_RATIO_DRIFT_OR_GAP | BLOCKED | Reforzar lower face ratio con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_JAW_ANGLE_DRIFT_OR_GAP | BLOCKED | Reforzar jaw angle con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_JAW_SOFTNESS_DRIFT_OR_GAP | BLOCKED | Reforzar jaw softness con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CHIN_PROJECTION_DRIFT_OR_GAP | BLOCKED | Reforzar chin projection con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CHIN_WIDTH_DRIFT_OR_GAP | BLOCKED | Reforzar chin width con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FACIAL_ASYMMETRY_MAP_DRIFT_OR_GAP | BLOCKED | Reforzar facial asymmetry map con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_AGE_FACE_SIGNATURE_DRIFT_OR_GAP | BLOCKED | Reforzar age face signature con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_EYE_SHAPE_DRIFT_OR_GAP | BLOCKED | Reforzar eye shape con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_EYE_SIZE_DRIFT_OR_GAP | BLOCKED | Reforzar eye size con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_EYE_SPACING_DRIFT_OR_GAP | BLOCKED | Reforzar eye spacing con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_EYE_TILT_DRIFT_OR_GAP | BLOCKED | Reforzar eye tilt con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_EYELID_FOLD_DRIFT_OR_GAP | BLOCKED | Reforzar eyelid fold con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_UPPER_LID_WEIGHT_DRIFT_OR_GAP | BLOCKED | Reforzar upper lid weight con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_LOWER_LID_TENSION_DRIFT_OR_GAP | BLOCKED | Reforzar lower lid tension con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_IRIS_COLOR_DRIFT_OR_GAP | BLOCKED | Reforzar iris color con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_IRIS_SIGNATURE_DRIFT_OR_GAP | BLOCKED | Reforzar iris signature con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CATCHLIGHT_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar catchlight rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_GAZE_SIGNATURE_DRIFT_OR_GAP | BLOCKED | Reforzar gaze signature con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_BLINK_PATTERN_DRIFT_OR_GAP | BLOCKED | Reforzar blink pattern con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_EYE_EMOTION_MAP_DRIFT_OR_GAP | BLOCKED | Reforzar eye emotion map con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_UNDER_EYE_TEXTURE_DRIFT_OR_GAP | BLOCKED | Reforzar under eye texture con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SCLERA_NATURAL_VARIATION_DRIFT_OR_GAP | BLOCKED | Reforzar sclera natural variation con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_BROW_DENSITY_DRIFT_OR_GAP | BLOCKED | Reforzar brow density con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_BROW_ARC_DRIFT_OR_GAP | BLOCKED | Reforzar brow arc con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_BROW_HEIGHT_DRIFT_OR_GAP | BLOCKED | Reforzar brow height con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_BROW_EYE_DISTANCE_DRIFT_OR_GAP | BLOCKED | Reforzar brow eye distance con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_NOSE_BRIDGE_DRIFT_OR_GAP | BLOCKED | Reforzar nose bridge con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_NOSE_DORSUM_DRIFT_OR_GAP | BLOCKED | Reforzar nose dorsum con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_NOSE_TIP_DRIFT_OR_GAP | BLOCKED | Reforzar nose tip con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_NOSTRIL_WIDTH_DRIFT_OR_GAP | BLOCKED | Reforzar nostril width con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_ALAR_SHAPE_DRIFT_OR_GAP | BLOCKED | Reforzar alar shape con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_PHILTRUM_LENGTH_DRIFT_OR_GAP | BLOCKED | Reforzar philtrum length con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_LIP_RATIO_DRIFT_OR_GAP | BLOCKED | Reforzar lip ratio con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_UPPER_LIP_SHAPE_DRIFT_OR_GAP | BLOCKED | Reforzar upper lip shape con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_LOWER_LIP_VOLUME_DRIFT_OR_GAP | BLOCKED | Reforzar lower lip volume con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CUPID_BOW_DRIFT_OR_GAP | BLOCKED | Reforzar cupid bow con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_MOUTH_WIDTH_DRIFT_OR_GAP | BLOCKED | Reforzar mouth width con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SMILE_SIGNATURE_DRIFT_OR_GAP | BLOCKED | Reforzar smile signature con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_TEETH_VISIBILITY_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar teeth visibility rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_WRONG_FACE_BLOCKER_DRIFT_OR_GAP | BLOCKED | Reforzar wrong face blocker con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SAME_FACE_BLOCKER_DRIFT_OR_GAP | BLOCKED | Reforzar same face blocker con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_GENERIC_BEAUTY_BLOCKER_DRIFT_OR_GAP | BLOCKED | Reforzar generic beauty blocker con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_OVER_SYMMETRY_BLOCKER_DRIFT_OR_GAP | BLOCKED | Reforzar over symmetry blocker con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_MAKEUP_FACE_DRIFT_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar makeup face drift rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_LENS_FACE_DISTORTION_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar lens face distortion rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_ANCHOR_FACE_MATCH_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar anchor face match rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FACE_REGRESSION_TEST_DRIFT_OR_GAP | BLOCKED | Reforzar face regression test con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HEIGHT_RANGE_DRIFT_OR_GAP | BLOCKED | Reforzar height range con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_BODY_BUILD_DRIFT_OR_GAP | BLOCKED | Reforzar body build con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_VISUAL_MASS_DRIFT_OR_GAP | BLOCKED | Reforzar visual mass con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SHOULDER_WIDTH_DRIFT_OR_GAP | BLOCKED | Reforzar shoulder width con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_NECK_LENGTH_DRIFT_OR_GAP | BLOCKED | Reforzar neck length con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CLAVICLE_VISIBILITY_DRIFT_OR_GAP | BLOCKED | Reforzar clavicle visibility con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_TORSO_LENGTH_DRIFT_OR_GAP | BLOCKED | Reforzar torso length con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_TORSO_LEG_RATIO_DRIFT_OR_GAP | BLOCKED | Reforzar torso leg ratio con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_WAIST_HIP_RELATION_DRIFT_OR_GAP | BLOCKED | Reforzar waist hip relation con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_PELVIS_WIDTH_DRIFT_OR_GAP | BLOCKED | Reforzar pelvis width con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_ARM_LENGTH_DRIFT_OR_GAP | BLOCKED | Reforzar arm length con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FOREARM_SHAPE_DRIFT_OR_GAP | BLOCKED | Reforzar forearm shape con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_WRIST_SCALE_DRIFT_OR_GAP | BLOCKED | Reforzar wrist scale con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_LEG_LINE_DRIFT_OR_GAP | BLOCKED | Reforzar leg line con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_KNEE_VISIBILITY_DRIFT_OR_GAP | BLOCKED | Reforzar knee visibility con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_ANKLE_SCALE_DRIFT_OR_GAP | BLOCKED | Reforzar ankle scale con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FOOT_SCALE_DRIFT_OR_GAP | BLOCKED | Reforzar foot scale con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_BODY_AGE_SIGNATURE_DRIFT_OR_GAP | BLOCKED | Reforzar body age signature con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HAND_SHAPE_DRIFT_OR_GAP | BLOCKED | Reforzar hand shape con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FINGER_LENGTH_DRIFT_OR_GAP | BLOCKED | Reforzar finger length con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FINGER_TAPER_DRIFT_OR_GAP | BLOCKED | Reforzar finger taper con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_KNUCKLE_VISIBILITY_DRIFT_OR_GAP | BLOCKED | Reforzar knuckle visibility con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_NAIL_STYLE_DRIFT_OR_GAP | BLOCKED | Reforzar nail style con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HAND_GESTURE_REST_DRIFT_OR_GAP | BLOCKED | Reforzar hand gesture rest con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HAND_OBJECT_CONTACT_DRIFT_OR_GAP | BLOCKED | Reforzar hand object contact con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FEET_GROUND_CONTACT_DRIFT_OR_GAP | BLOCKED | Reforzar feet ground contact con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_TOE_VISIBILITY_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar toe visibility rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SHOE_FIT_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar shoe fit rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HANDS_AGE_SIGNATURE_DRIFT_OR_GAP | BLOCKED | Reforzar hands age signature con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CONTACT_PRESSURE_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar contact pressure rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_CENTER_OF_GRAVITY_DRIFT_OR_GAP | BLOCKED | Reforzar center of gravity con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_POSTURE_BASE_DRIFT_OR_GAP | BLOCKED | Reforzar posture base con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SPINE_CURVE_DRIFT_OR_GAP | BLOCKED | Reforzar spine curve con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SHOULDER_BEHAVIOR_DRIFT_OR_GAP | BLOCKED | Reforzar shoulder behavior con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HIP_ALIGNMENT_DRIFT_OR_GAP | BLOCKED | Reforzar hip alignment con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_WEIGHT_DISTRIBUTION_DRIFT_OR_GAP | BLOCKED | Reforzar weight distribution con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_STANDING_BALANCE_DRIFT_OR_GAP | BLOCKED | Reforzar standing balance con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SITTING_BALANCE_DRIFT_OR_GAP | BLOCKED | Reforzar sitting balance con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_WALKING_WEIGHT_DRIFT_OR_GAP | BLOCKED | Reforzar walking weight con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_DANCE_RANGE_DRIFT_OR_GAP | BLOCKED | Reforzar dance range con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FITNESS_TONE_DRIFT_OR_GAP | BLOCKED | Reforzar fitness tone con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_BODY_ENERGY_SIGNATURE_DRIFT_OR_GAP | BLOCKED | Reforzar body energy signature con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SAME_BODY_BLOCKER_DRIFT_OR_GAP | BLOCKED | Reforzar same body blocker con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_WRONG_AGE_BODY_BLOCKER_DRIFT_OR_GAP | BLOCKED | Reforzar wrong age body blocker con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_IMPOSSIBLE_POSE_BLOCKER_DRIFT_OR_GAP | BLOCKED | Reforzar impossible pose blocker con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_BODY_LENS_DISTORTION_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar body lens distortion rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_PROPORTION_REPAIR_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar proportion repair rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HANDS_FEET_REPAIR_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar hands feet repair rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_ADULT_BODY_SAFETY_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar adult body safety rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SKIN_TONE_DRIFT_OR_GAP | BLOCKED | Reforzar skin tone con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SKIN_SUBTONE_DRIFT_OR_GAP | BLOCKED | Reforzar skin subtone con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_PORE_DENSITY_DRIFT_OR_GAP | BLOCKED | Reforzar pore density con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_TEXTURE_ZONE_MAP_DRIFT_OR_GAP | BLOCKED | Reforzar texture zone map con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_NATURAL_MARKS_DRIFT_OR_GAP | BLOCKED | Reforzar natural marks con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FINE_LINES_DRIFT_OR_GAP | BLOCKED | Reforzar fine lines con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SPECULAR_ZONES_DRIFT_OR_GAP | BLOCKED | Reforzar specular zones con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_MATTE_ZONES_DRIFT_OR_GAP | BLOCKED | Reforzar matte zones con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_MAKEUP_RULES_DRIFT_OR_GAP | BLOCKED | Reforzar makeup rules con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SKIN_LIGHT_RESPONSE_DRIFT_OR_GAP | BLOCKED | Reforzar skin light response con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SKIN_CLIMATE_RESPONSE_DRIFT_OR_GAP | BLOCKED | Reforzar skin climate response con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SKIN_AGE_RESPONSE_DRIFT_OR_GAP | BLOCKED | Reforzar skin age response con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_ANTI_DOLL_MARKERS_DRIFT_OR_GAP | BLOCKED | Reforzar anti doll markers con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_NO_AIRBRUSH_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar no airbrush rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SKIN_CAMERA_DISTANCE_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar skin camera distance rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HAIR_COLOR_BASE_DRIFT_OR_GAP | BLOCKED | Reforzar hair color base con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HAIR_SUBTONE_DRIFT_OR_GAP | BLOCKED | Reforzar hair subtone con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HAIR_DENSITY_DRIFT_OR_GAP | BLOCKED | Reforzar hair density con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_STRAND_THICKNESS_DRIFT_OR_GAP | BLOCKED | Reforzar strand thickness con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HAIRLINE_SHAPE_DRIFT_OR_GAP | BLOCKED | Reforzar hairline shape con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HAIR_LENGTH_DRIFT_OR_GAP | BLOCKED | Reforzar hair length con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HAIR_PARTING_DRIFT_OR_GAP | BLOCKED | Reforzar hair parting con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_LAYERING_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar layering rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_VOLUME_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar volume rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FRIZZ_LEVEL_DRIFT_OR_GAP | BLOCKED | Reforzar frizz level con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_BABY_HAIRS_DRIFT_OR_GAP | BLOCKED | Reforzar baby hairs con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_FLYAWAY_HAIRS_DRIFT_OR_GAP | BLOCKED | Reforzar flyaway hairs con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HUMIDITY_RESPONSE_DRIFT_OR_GAP | BLOCKED | Reforzar humidity response con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_WIND_RESPONSE_DRIFT_OR_GAP | BLOCKED | Reforzar wind response con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_STRAND_MOTION_DRIFT_OR_GAP | BLOCKED | Reforzar strand motion con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HAIR_SHADOW_CONTACT_DRIFT_OR_GAP | BLOCKED | Reforzar hair shadow contact con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_HAIR_FACE_OCCLUSION_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar hair face occlusion rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_EYE_WETNESS_DRIFT_OR_GAP | BLOCKED | Reforzar eye wetness con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SCLERA_NATURAL_VARIATION_DRIFT_OR_GAP | BLOCKED | Reforzar sclera natural variation con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_LIP_TEXTURE_DRIFT_OR_GAP | BLOCKED | Reforzar lip texture con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_LIP_SPECULAR_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar lip specular rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_TEETH_NATURAL_RULE_DRIFT_OR_GAP | BLOCKED | Reforzar teeth natural rule con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
| FAIL_SKIN_HAIR_COLOR_HARMONY_DRIFT_OR_GAP | BLOCKED | Reforzar skin hair color harmony con descriptor concreto, negative/avoid, regla de cámara/luz/movimiento y test de regresión. |
