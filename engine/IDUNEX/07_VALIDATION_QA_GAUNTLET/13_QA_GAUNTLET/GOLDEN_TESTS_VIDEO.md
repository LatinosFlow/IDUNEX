...
Cada prueba es específica para VIDEO; no se permite copiar pasos genéricos sin parámetros de modalidad.


## GT_VIDEO_FRAME_START_MID_END_LOCK
- test_id: GT_VIDEO_FRAME_START_MID_END_LOCK
- modality: video
...
## GT_VIDEO_FACE_MORPH_BLOCKER
- test_id: GT_VIDEO_FACE_MORPH_BLOCKER
- modality: video
...
## GT_VIDEO_BODY_MORPH_BLOCKER
- test_id: GT_VIDEO_BODY_MORPH_BLOCKER
- modality: video
...
## GT_VIDEO_WARDROBE_CONTINUITY
- test_id: GT_VIDEO_WARDROBE_CONTINUITY
- modality: video
...
## GT_VIDEO_LIGHTING_CONTINUITY
- test_id: GT_VIDEO_LIGHTING_CONTINUITY
- modality: video
...
## GT_VIDEO_CAMERA_PATH_STABILITY
- test_id: GT_VIDEO_CAMERA_PATH_STABILITY
- modality: video
