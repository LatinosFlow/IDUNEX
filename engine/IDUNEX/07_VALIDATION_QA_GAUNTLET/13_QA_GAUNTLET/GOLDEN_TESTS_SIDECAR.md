# GOLDEN TESTS SIDECAR

Cada prueba es específica para SIDECAR; no se permite copiar pasos genéricos sin parámetros de modalidad.


## GT_SIDECAR_SCHEMA
- test_id: GT_SIDECAR_SCHEMA
- modality: sidecar
...
## GT_SIDECAR_SOURCE_TRACE
- test_id: GT_SIDECAR_SOURCE_TRACE
- modality: sidecar
...
## GT_SIDECAR_FIELD_TRACE
- test_id: GT_SIDECAR_FIELD_TRACE
- modality: sidecar
