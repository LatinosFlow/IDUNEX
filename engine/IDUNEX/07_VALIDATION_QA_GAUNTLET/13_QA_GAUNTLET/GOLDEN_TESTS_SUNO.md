...
Cada prueba es específica para SUNO; no se permite copiar pasos genéricos sin parámetros de modalidad.


## GT_SUNO_GENRE_IDENTITY
- test_id: GT_SUNO_GENRE_IDENTITY
- modality: suno
...
- test_id: GT_SUNO_LYRIC_PERSONALITY
- modality: suno
...
## GT_SUNO_NEGATIVE_TAGS
- test_id: GT_SUNO_NEGATIVE_TAGS
- modality: suno
...
## GT_SUNO_NO_GENERIC_OUTPUT
- test_id: GT_SUNO_NO_GENERIC_OUTPUT
- modality: suno
