# GOLDEN TESTS COPILOT_DOCX

Cada prueba es específica para COPILOT_DOCX; no se permite copiar pasos genéricos sin parámetros de modalidad.


## GT_COPILOT_DOCX_HEADINGS
- test_id: GT_COPILOT_DOCX_HEADINGS
- modality: copilot_docx
...
## GT_COPILOT_DOCX_GROUNDING
- test_id: GT_COPILOT_DOCX_GROUNDING
- modality: copilot_docx
...
## GT_COPILOT_DOCX_NO_LOSS
- test_id: GT_COPILOT_DOCX_NO_LOSS
- modality: copilot_docx
...
- test_id: GT_COPILOT_DOCX_READBACK
- modality: copilot_docx
...
## GT_COPILOT_DOCX_VERSION_ISOLATION
- test_id: GT_COPILOT_DOCX_VERSION_ISOLATION
- modality: copilot_docx
