# MOTOR_SELF_TEST_PROJECT_FACTORY_SIMULATION
...
## actual_value
artifact=MOTOR_SELF_TEST_PROJECT_FACTORY_SIMULATION; status=RESTORED; blocking=true; audit_scope=engine_and_project_factory
