...
Cada prueba es específica para IMAGE; no se permite copiar pasos genéricos sin parámetros de modalidad.


## GT_IMAGE_FRONT_IDENTITY_LOCK
- test_id: GT_IMAGE_FRONT_IDENTITY_LOCK
- modality: image
...
## GT_IMAGE_3Q_IDENTITY_LOCK
- test_id: GT_IMAGE_3Q_IDENTITY_LOCK
- modality: image
...
## GT_IMAGE_PROFILE_IDENTITY_LOCK
- test_id: GT_IMAGE_PROFILE_IDENTITY_LOCK
- modality: image
...
## GT_IMAGE_FULL_BODY_PROPORTIONS
- test_id: GT_IMAGE_FULL_BODY_PROPORTIONS
- modality: image
...
## GT_IMAGE_HANDS_FEET_ANATOMY
- test_id: GT_IMAGE_HANDS_FEET_ANATOMY
- modality: image
...
## GT_IMAGE_SKIN_HAIR_REALISM
- test_id: GT_IMAGE_SKIN_HAIR_REALISM
- modality: image
- required_inputs: Profile360 field P360_QA_1267, source_ids SRC_025_Golden_Tests_de_identidad, SRC_030_No-loss_migration_y_compatibilidad, SRC_038_PAIRWISE_UNIQUENESS_METRICS, adapter chatgpt_json_txt_adapter, locks activos y sidecar schema.
- steps: 1) cargar campos de la modalidad; 2) generar especificación controlada; 3) comparar parámetros medibles; 4) validar continuidad/identidad/traza; 5) registrar sidecar y hash; 6) ejecutar retest si hay WARNING/FAIL.
- expected_result: output coherente con profile360_qa y sin drift.
- fail_conditions: falta source trace, campo genérico, adapter incorrecto, placeholder final, drift, schema fail o sidecar incompleto.
- measurement_method: checklist por modalidad + matriz canónica + validator.
- source_ids_required: SRC_025_Golden_Tests_de_identidad, SRC_030_No-loss_migration_y_compatibilidad, SRC_038_PAIRWISE_UNIQUENESS_METRICS, SRC_047_JSON_SCHEMA_LINTER_NOLOSS
- field_ids_required: P360_QA_1267
- adapter_required: chatgpt_json_txt_adapter
- fail_codes_triggered: FAIL_QA_1267_COLOR_TEMPERATURE_QA_MATRIX
- fallback_fix: Si falla color_temperature_qa_matrix, recargar primary_source_id SRC_025_Golden_Tests_de_identidad, cruzar supporting_source_ids SRC_030_No-loss_migration_y_com...
- retest_required: true
- production_decision: prior_validation_reference=NON_AUTHORITY_REFERENCE; active_validation_scope=H261_H268_RUNTIME_TRUTHFULNESS_SCOPE only if PASS; no GLOBAL_GO.

## GT_IMAGE_WARDROBE_PHYSICS
- test_id: GT_IMAGE_WARDROBE_PHYSICS
- modality: image
- required_inputs: Profile360 field P360_BODY_1478, source_ids SRC_003_Antropometr_a_corporal_avanzada, SRC_031_Proporciones_fitness_por_edad_adulta, SRC_039_BODY_BEAUTY_FITNESS_EDITORIAL_NON_EXPLICIT, adapter image_prompt_adapter, locks activos y sidecar schema.
- steps: 1) cargar campos de la modalidad; 2) generar especificación controlada; 3) comparar parámetros medibles; 4) validar continuidad/identidad/traza; 5) registrar sidecar y hash; 6) ejecutar retest si hay WARNING/FAIL.
- expected_result: output coherente con profile360_body y sin drift.
- fail_conditions: falta source trace, campo genérico, adapter incorrecto, placeholder final, drift, schema fail o sidecar incompleto.
- measurement_method: checklist por modalidad + matriz canónica + validator.
- source_ids_required: SRC_003_Antropometr_a_corporal_avanzada, SRC_031_Proporciones_fitness_por_edad_adulta, SRC_039_BODY_BEAUTY_FITNESS_EDITORIAL_NON_EXPLICIT, SRC_038_PAIRWISE_UNIQUENESS_METRICS
- field_ids_required: P360_BODY_1478
- adapter_required: image_prompt_adapter
- fail_codes_triggered: FAIL_BODY_1478_BODY_AGE_SIGNATURE_VENDOR_REPAIR
- fallback_fix: Si falla body_age_signature_vendor_repair, recargar primary_source_id SRC_003_Antropometr_a_corporal_avanzada, cruzar supporting_source_ids SRC_031_Proporciones...
- retest_required: true
- production_decision: prior_validation_reference=NON_AUTHORITY_REFERENCE; active_validation_scope=H261_H268_RUNTIME_TRUTHFULNESS_SCOPE only if PASS; no GLOBAL_GO.
