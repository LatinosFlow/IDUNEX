...
REQUIRED_TOKENS = [
 'DEMO_READY_INPUT_BLOCK','EDITABLE_FIELDS_FOR_CUSTOM_PROJECTS','TEMPLATE_REQUIRED_FIELDS','DO_NOT_EXECUTE_TEMPLATE_WITH_PLACEHOLDERS','GENERIC_SKELETON_NON_AUTHORITY','PROJECT_FILENAME_CANON','PROJECT_NAME_SLUG','PROJECT_UID','PROJECT_OUTPUT_CONTRACT','PROJECT_STATUS_CONTRACT','PROJECT_DEMO_PASS_GATE','PROJECT_TEMPLATE_FILL_VALIDATOR','PROJECT_NO_PLACEHOLDER_EXECUTION_GATE'
]
REQUIRED_PATHS = [
 ...
 '03_PROJECT_FACTORY/04_DELIVERY_GATES/PROJECT_DEMO_PASS_GATE.json',
 '03_PROJECT_FACTORY/09_H281_H310_PROJECT_OUTPUT_CONTRACTS/PROJECT_FILENAME_CANON.json',
 '03_PROJECT_FACTORY/09_H281_H310_PROJECT_OUTPUT_CONTRACTS/PROJECT_STATUS_CONTRACT.json',
 '03_PROJECT_FACTORY/09_H281_H310_PROJECT_OUTPUT_CONTRACTS/PROJECT_TEMPLATE_FILL_VALIDATOR.json',
