...
REQUIRED_PATHS = [
 ...
 '03_PROJECT_FACTORY/09_PROJECT_OUTPUT_CONTRACTS/PROJECT_FILENAME_CANON.json',
 '03_PROJECT_FACTORY/09_PROJECT_OUTPUT_CONTRACTS/PROJECT_STATUS_CONTRACT.json',
 '03_PROJECT_FACTORY/09_PROJECT_OUTPUT_CONTRACTS/PROJECT_TEMPLATE_FILL_VALIDATOR.json',
