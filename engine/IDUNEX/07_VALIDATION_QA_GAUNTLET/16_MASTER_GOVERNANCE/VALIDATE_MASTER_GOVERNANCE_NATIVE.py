...
try:
    ...
    for rel in ['00_INDEX/RELEASE_CERTIFICATE.txt','00_INDEX/VERSION_MANIFEST.json','00_INDEX/FINAL_AUDIT_REPORT.md','11_RELEASE_INTERNAL/RELEASE_CERTIFICATE.txt','11_RELEASE_INTERNAL/FINAL_AUDIT_REPORT.md','11_RELEASE_INTERNAL/FINAL_MACHINE_AUDIT_SUMMARY.json','11_RELEASE_INTERNAL/H391_H410_DIRECT_C_0d8663fc.json','11_RELEASE_INTERNAL/H391_H410_EXECUTED_202784b5.json','99_MANIFESTS_SHA_LINEAGE/FINAL_RECOMPUTED_RELEASE_EVIDENCE.json','99_MANIFESTS_SHA_LINEAGE/FINAL_RELEASE_STATUS.json']:
        tx=(ROOT/rel).read_text(encoding='utf-8', errors='ignore')
