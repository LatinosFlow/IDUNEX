...
REQUIRED_RULE_IDS = ['GOV-CORE-001','GOV-LVL-001','VER-SEM-001','VER-COR-001','ENG-CORE-001','ENG-STR-001','PRJ-CON-001','PRJ-DEMO-001','AGT-LOAD-001','CAN-P360-001','CAN-TEXT-001','RES-CORPUS-001','RUN-10N-001','PMT-AJ-001','VAL-REC-001','AUD-MAX-001','UPD-MAT-001','MIG-MAT-001','BRD-DEF-001','BRD-PAL-001','REF-SAFE-001','SAF-ADULT-001','ZIP-EXT-001','DUP-EXA-001','LIN-HDEM-001','BLT-NBH-001','CRT-FALSE-001','PRJ-NAME-001','PRJ-TPL-001','PRJ-SKEL-001','PRJ-STAT-001','PRJ-DEMO-GATE-001']
...
REQUIRED_PATHS = [
 '00_INDEX/MASTER_GOVERNANCE_MAP.json','00_INDEX/MASTER_GOVERNANCE_MAP.md','01_CANON_REGISTRIES/MASTER_GOVERNANCE_RULE_REGISTRY.json','01_CANON_REGISTRIES/15_SCHEMAS/MASTER_GOVERNANCE_RULE_REGISTRY.schema.json','00_INDEX/00_CONTROL_CENTER/ENGINE_PROJECT_AGENT_LEVEL_CONTRACTS.json','00_INDEX/00_CONTROL_CENTER/ROOT_STRUCTURE_EQUIVALENCE_MAP.json','12_OUTPUT_CONTRACTS/ENGINE_OUTPUT_CONTRACT.json','12_OUTPUT_CONTRACTS/PROJECT_OUTPUT_CONTRACT.json','12_OUTPUT_CONTRACTS/AGENT_LOAD_CONTRACT.json','02_RESEARCH_CORPUS/RES_POLICY_REGISTRY.json','13_UPDATE_MIGRATION/UPDATE_MIGRATION_CONTRACTS.json','14_HISTORICAL_NON_AUTHORITY/H_DEMOTION_REGISTRY.json','03_PROJECT_FACTORY/04_DELIVERY_GATES/ZIP_EXT_001_WHOLE_ZIP_EXTERNAL_AUTHORITY_GATE.json','03_PROJECT_FACTORY/04_DELIVERY_GATES/STABLE_FAMILY_GOVERNANCE_GATE.json','07_VALIDATION_QA_GAUNTLET/16_MASTER_GOVERNANCE/MASTER_GOVERNANCE_VALIDATION_CONTRACT.json','07_VALIDATION_QA_GAUNTLET/16_MASTER_GOVERNANCE/NO_BLOAT_NO_HISTORY_POLICY.json','03_PROJECT_FACTORY/04_DELIVERY_GATES/PROJECT_NO_PLACEHOLDER_EXECUTION_GATE.json','03_PROJECT_FACTORY/04_DELIVERY_GATES/GENERIC_SKELETON_NON_AUTHORITY_GATE.json','03_PROJECT_FACTORY/04_DELIVERY_GATES/PROJECT_DEMO_PASS_GATE.json','03_PROJECT_FACTORY/09_H281_H310_PROJECT_OUTPUT_CONTRACTS/PROJECT_FILENAME_CANON.json','03_PROJECT_FACTORY/09_H281_H310_PROJECT_OUTPUT_CONTRACTS/PROJECT_STATUS_CONTRACT.json','03_PROJECT_FACTORY/09_H281_H310_PROJECT_OUTPUT_CONTRACTS/PROJECT_TEMPLATE_FILL_VALIDATOR.json','07_VALIDATION_QA_GAUNTLET/16_MASTER_GOVERNANCE/VALIDATE_PROMPTS_PROJECT_POLICY.py']
fail=[]; checks={}; details={}
...
try:
    zipg=load('03_PROJECT_FACTORY/04_DELIVERY_GATES/ZIP_EXT_001_WHOLE_ZIP_EXTERNAL_AUTHORITY_GATE.json')
...
try:
    ...
    add('NO_PROJECT_DEFAULT_LEAKAGE_CONTRACTED', all(t in blocked for t in ['Proyecto 000 Demo','LatinosFlow','brand palettes']), {'blocked_defaults':lvl.get('blocked_defaults',[])})
except Exception as e:
...
try:
    ...
    for rel in ['00_INDEX/RELEASE_CERTIFICATE.txt','00_INDEX/VERSION_MANIFEST.json','00_INDEX/FINAL_AUDIT_REPORT.md','11_RELEASE_INTERNAL/RELEASE_CERTIFICATE.txt','11_RELEASE_INTERNAL/FINAL_AUDIT_REPORT.md','11_RELEASE_INTERNAL/FINAL_MACHINE_AUDIT_SUMMARY.json','11_RELEASE_INTERNAL/H391_H410_DIRECT_CANONICAL_CLOSURE_REPORT.json','11_RELEASE_INTERNAL/H391_H410_EXECUTED_VALIDATION_COMPACT_EVIDENCE.json','99_MANIFESTS_SHA_LINEAGE/FINAL_RECOMPUTED_RELEASE_EVIDENCE.json','99_MANIFESTS_SHA_LINEAGE/FINAL_RELEASE_STATUS.json']:
        tx=(ROOT/rel).read_text(encoding='utf-8', errors='ignore')
...
try:
    tech=load('01_CANON_REGISTRIES/PROFILE360_TECHNICAL_EXTENSIONS_FULL10/TECHEXT_FULL10_OFFICIAL_FIELD_REGISTRY.json')
...
try:
    ...
    allow=load('99_MANIFESTS_SHA_LINEAGE/ENGINE_EXACT_DUPLICATE_ALLOWLIST.json')
...
try:
    matrix=load('11_RELEASE_INTERNAL/H238_FULL_31_PROJECT_MATRIX_SUMMARY.json')
...
try:
    mut=load('99_MANIFESTS_SHA_LINEAGE/FACTORY_MUTATION_SELF_TEST_EXECUTABLE_PROOF.json')
...
try:
    mx=load('11_RELEASE_INTERNAL/H238_FULL_31_PROJECT_MATRIX_SUMMARY.json')
...
try:
    ...
    required_policy_tokens=['DEMO_READY_INPUT_BLOCK','EDITABLE_FIELDS_FOR_CUSTOM_PROJECTS','TEMPLATE_REQUIRED_FIELDS','DO_NOT_EXECUTE_TEMPLATE_WITH_PLACEHOLDERS','GENERIC_SKELETON_NON_AUTHORITY','PROJECT_FILENAME_CANON','PROJECT_NAME_SLUG','PROJECT_UID','PROJECT_STATUS_CONTRACT','PROJECT_DEMO_PASS_GATE','PROJECT_TEMPLATE_FILL_VALIDATOR','PROJECT_NO_PLACEHOLDER_EXECUTION_GATE']
