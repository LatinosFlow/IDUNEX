...
if (ROOT/'03_PROJECT_FACTORY/02_PROTOCOLS/IDUNEX_PROJECT_FACTORY_v1.0.0.py').exists():
    for rel in ['14_HISTORICAL_NON_AUTHORITY/AUD_008_ACTIVE_HISTORY/11_RELEASE_INTERNAL/OBSOLETE_HISTORY_D_94264e3d.json','14_HISTORICAL_NON_AUTHORITY/AUD_008_ACTIVE_HISTORY/03_PROJECT_FACTORY/04_DELIVERY_GATES/H213_H236_CANONICAL_GATES.json']:
